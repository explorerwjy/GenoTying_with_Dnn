...
class window_tensor():
    def __init__(self, line):
        ...
        self.Qual = line[13 + WIDTH *
                         (HEIGHT + 1): 13 + WIDTH * (HEIGHT + 1) * 2]
        self.Strand = line[13 + WIDTH *
                           (HEIGHT + 1) * 2: 13 + WIDTH * (HEIGHT + 1) * 3]
...
def main():
    ...
    hand = gzip.open(
        '/home/local/users/jw/TensorFlowCaller/Nebraska_NA12878_HG001_TruSeq_Exome/sample_1/windows_testing.txt.gz',
        'rb')
