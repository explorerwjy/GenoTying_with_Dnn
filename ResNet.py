...
class ResNet():
    ...
    def Inference(self, x, is_training, num_class=3, num_blocks=[3, 4, 6, 3], use_bias=False, bottleneck=True):
        c = Config()
    ...
    def Train(self, total_loss, global_step, init_lr=FLAGS.learning_rate, optimizer='Adam'):
